...
if training==True:
    ...
    for i in range(5):
        time.sleep(1)
        url='https://www.geoguessr.com/live-challenge/bd5fa0fc-704d-4923-acf2-f94f8e47db90'
        driver.get(url)
        ...
        time.sleep(10)
        for css in ['#__next > div > div > main > div.panorama-question_layout__wSP7g > div > div.guess_mapContainer__QsnpR','#__next > div > div > main > div.panorama-question_layout__wSP7g > div > div.game-panorama_compass__MvB1f','#__next > div > div > main > div.clock_clock__jWxVu','#__next > div > div > main > div.panorama-question_layout__wSP7g > div > aside > div','#__next > div > div > main > div.guess-status_guessStatus__xLyp3','#__next > div > div > main > div.chat_root__C4uNt > div.chat_chatInput__xvTlm','#__next > div > div > main > div.map-status_status__iAYih']:
                    ...
                    """, element)
        time.sleep(1)
        driver.find_element(By.CSS_SELECTOR,"body").screenshot("C:\\Users\\Jack\\Downloads\\data\\test\\FO\\testimage.png")        
        if turning==True:
            for i in range(6):
                rotate_canvas()
                time.sleep(0.1)
                driver.find_element(By.CSS_SELECTOR,'body').screenshot(f"C:\\Users\\Jack\\Downloads\\data\\test\\FO\\testimage{i}.png")
        ...
        time.sleep(10)
        WebDriverWait(driver, 10000).until(EC.presence_of_element_located((By.CSS_SELECTOR, "#__next > div > div > main > div.game_container__HuoL9 > div > div > div.multiplayer-round-results_playerActionSection__BhNxJ > button"))).click()
#__next > div > div > main > div.game_container__HuoL9 > div > div > div.multiplayer-round-results_playerActionSection__BhNxJ > button
